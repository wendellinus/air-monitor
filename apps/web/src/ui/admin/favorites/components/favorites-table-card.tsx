    ...
    <div className="overflow-hidden rounded-lg border border-border/80 bg-card shadow-sm">
      <Table>
        <TableHeader className="bg-muted/30">
          <TableRow>
            <TableHead>{props.t('admin.favorites.table.user')}</TableHead>
            <TableHead>{props.t('admin.favorites.table.city')}</TableHead>
            <TableHead>{props.t('admin.favorites.table.region')}</TableHead>
            <TableHead>{props.t('admin.favorites.table.cityId')}</TableHead>
            <TableHead>{props.t('admin.favorites.table.createdAt')}</TableHead>
            <TableHead className="w-20 text-right">{props.t('admin.favorites.table.actions')}</TableHead>
          </TableRow>
        </TableHeader>
        <TableBody>
