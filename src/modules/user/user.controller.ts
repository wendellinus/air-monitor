...
export class UserController {
  ...
  @Get('user/me')
  async me(@CurrentUser() user: JwtUser): Promise<unknown> {
  ...
  @Get('users')
  async list(@Query() q: PageQueryDto): Promise<unknown> {
  ...
  @Roles('admin', 'operator')
  @Get('users/search')
  async search(@Query() q: SearchUserQueryDto): Promise<unknown> {
